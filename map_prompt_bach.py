...
np.save("train_bach_values_prompt_v.npy", value)
np.save("train_bach_indexes_prompt_v.npy", index)
print("training done")
split = "val"
data =  datasets.BACH(
                        root="/export/datasets/public/BACH",
...
data.configure()
value, index = get_pairing(data, embed_tensor)
np.save("val_bach_values_prompt_v.npy", value)
np.save("val_bach_indexes_prompt_v.npy", index)
print("val done")
