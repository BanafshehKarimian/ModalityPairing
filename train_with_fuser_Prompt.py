from Data.PCAMTDataLoaderConchPrompt import PCAMTDataModule
...
from Models.LateFuser import FuserModel
from Models.LateFuserKD import FuserModelKD
import numpy as np
import random
...
if __name__ == "__main__":
    ...
    datasets_conf = {"pcam":{"num_classes": 2, "ds_class": PCAMTDataModule, "text_model": TextNetModel, "text_model_path": "./best_models/pcam_TCGA_Prompt.ckpt"},\
                    "bach":{"num_classes": 4, "ds_class": BACHTDataModule, "text_model": TextNetModel, "text_model_path": "./best_models/bach_TCGA.ckpt"}}
    model_conf = {"UNI": {"model": UNINetModel, "path": {"pcam": "./best_models/run1/pcam_UNI.ckpt", "bach": "./best_models/run1/bach_UNI.ckpt"}},\
                    "DINOL14": {"model": DINOL14NetModel, "path": {"pcam": "./best_models/run1/pcam_DINOL14.ckpt", "bach": "./best_models/bach_vitl14.ckpt"}},\
                    "VITS_8": {"model": VITSNetModel8, "path": {"pcam": "./best_models/run1/pcam_VITS_8.ckpt", "bach": "./best_models/run1/bach_vits8.ckpt"}},\
                    "VITS_16": {"model": VITSNetModel16, "path": {"pcam": "./best_models/run1/pcam_VITS_16.ckpt", "bach": "./best_models/run1/bach_vits16.ckpt"}},\
                    "VITB_8": {"model": VITBNetModel8, "path": {"pcam": "./best_models/run1/pcam_VITB_8.ckpt", "bach": "./best_models/run1/bach_vitb8.ckpt"}},\
                    "VITB_16": {"model": VITBNetModel16, "path": {"pcam": "./best_models/run1/pcam_VITB_16.ckpt", "bach": "./best_models/run1/bach_vitb16.ckpt"}}}
    ...
    early_stop_callback = EarlyStopping(
            monitor="train_loss",
            min_delta=0.01,
            patience=5,  # NOTE no. val epochs, not train epochs
            verbose=False,
            mode="min",
        )
    callbacks=[]
