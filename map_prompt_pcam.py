...
classes = ['healthy tissue', 'tumor tissue']
texts = []
for c in classes:
...
np.save("train_pcam_values_prompt_v.npy", value)
np.save("train_pcam_indexes_prompt_v.npy", index)
print("training done")
'''
data =  datasets.PCAM(
                root="/export/datasets/public/",
...
value, index = get_pairing(data, embed_tensor)
np.save("test_pcam_values_prompt_v.npy", value)
np.save("test_pcam_indexes_prompt_v.npy", index)
print("testing done")
...
value, index = get_pairing(data, embed_tensor)
np.save("val_pcam_values_prompt_v.npy", value)
np.save("val_pcam_indexes_prompt_v.npy", index)
print("val done")
