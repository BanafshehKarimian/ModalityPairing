...
if __name__ == "__main__":
    ...
    model_conf = {"UNI": {"model": UNINetModel, "path": {"pcam": "./best_models/pcam_UNI.ckpt", "bach": "./best_models/bach_UNI.ckpt"}},\
                    "DINOL14": {"model": DINOL14NetModel, "path": {"pcam": "./best_models/pcam_DINOL14.ckpt", "bach": "./best_models/bach_vitl14.ckpt"}},\
                    "VITS_8": {"model": VITSNetModel8, "path": {"pcam": "./best_models/pcam_VITS_8.ckpt", "bach": "./best_models/bach_vits8.ckpt"}},\
                    "VITS_16": {"model": VITSNetModel16, "path": {"pcam": "./best_models/pcam_VITS_16.ckpt", "bach": "./best_models/bach_vits16.ckpt"}},\
                    "VITB_8": {"model": VITBNetModel8, "path": {"pcam": "./best_models/pcam_VITB_8.ckpt", "bach": "./best_models/bach_vitb8.ckpt"}},\
                    "VITB_16": {"model": VITBNetModel16, "path": {"pcam": "./best_models/pcam_VITB_16.ckpt", "bach": "./best_models/bach_vitb16.ckpt"}}}
    learners = {"late_fusion":FuserModelKD}
    ...
    '''Loading Data'''
    if args.model in ["UNI"] and args.ds in ["bach"]:
