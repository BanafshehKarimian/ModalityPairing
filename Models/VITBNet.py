...
class VITBNetModel8(pl.LightningModule):
    def __init__(self, num_classes = 2, batch_size = 64, lr=0.001, momentum=0.9, nesterov = True, weight_decay = 0.0001, bbfroze = True, modeltype = "vitb8"):
        super().__init__()
...
class VITBNetModel16(pl.LightningModule):
    def __init__(self, num_classes = 2, batch_size = 64, lr=0.001, momentum=0.9, nesterov = True, weight_decay = 0.0001, bbfroze = True, modeltype = "vitb16"):
        super().__init__()
        self.num_classes = num_classes        
        self.lr = lr
        self.momentum = momentum
