...
class VITSNetModel8(pl.LightningModule):
    def __init__(self, num_classes = 2, batch_size = 64, lr=0.001, momentum=0.9, nesterov = True, weight_decay = 0.0001, bbfroze = True, modeltype = "vits8"):
        super().__init__()
...
class VITSNetModel16(pl.LightningModule):
    def __init__(self, num_classes = 2, batch_size = 64, lr=0.001, momentum=0.9, nesterov = True, weight_decay = 0.0001, bbfroze = True, modeltype = "vits16"):
        super().__init__()
        self.num_classes = num_classes        
        self.lr = lr
        self.momentum = momentum
